...
class Hand_Data(DetectionDataset):
    def __init__(self, *args, **kwargs):
        super(Hand_Data, self).__init__(*args, **kwargs)
        ...
        for idx, item in enumerate(self.samples):
            ...
            vid_id = item['frames'][0]['img_path'].split('/')[-2]
            ...
            for frm in frames:
                ...
                for obj_ind, obj in enumerate(objs):
                    ...
                    f = [{'objs':[obj], 'img_path':img_path, 'frame_id':frm['frame_id']}]
                            #'frame_idx':frm['frame_idx']}]
    ...
    def __getitem__(self, idx):
        ...
        for frame_ind in range(len(vid_info['frames'])):
            ...
            #input_data = cv2.imread(frame_path) #Keep as BGR
        ...
        annot_dict['vid_id']     = frame_path.split('/')[-2] 
