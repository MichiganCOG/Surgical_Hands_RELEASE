...
def computeMetrics(gtFramesAll, motAll, outputDir, bSaveAll, bSaveSeq):
    ...
    for i in range(nJoints):
        ...
        total_det  += numDet 
        total_fp   += numFP
        total_miss += metricsMidAll['num_misses'][0,i]
        total_swit += metricsMidAll['num_switches'][0,i]

    print('Objs: {}, Dets: {}, FP: {}, Misses: {}, Switches: {}'.format(total_obj, total_det, total_fp, total_miss, total_swit))
